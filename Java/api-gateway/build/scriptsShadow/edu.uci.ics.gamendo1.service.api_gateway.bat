...
set CLASSPATH=%APP_HOME%\lib\edu.uci.ics.gamendo1.service.api_gateway.jar

@rem Execute edu.uci.ics.gamendo1.service.api_gateway
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %EDU_UCI_ICS_GAMENDO1_SERVICE_API_GATEWAY_OPTS%  -jar "%CLASSPATH%" %CMD_LINE_ARGS%
