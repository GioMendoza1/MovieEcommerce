...
public class ServiceIdm {

    public static ServiceIdm serviceIdm;

    public static Configs configs = new Configs();
    private static Connection con;

    public static void main(String[] args) {
        serviceIdm = new ServiceIdm();
        serviceIdm.initService(args);
    }

    private void initService(String[] args) {
        // Validate arguments
        serviceIdm.validateArguments(args);
        // Exec the arguments
        serviceIdm.execArguments(args);
        // Initialize logging
        initLogging();
    ...
    private void initHTTPServer() {
        ...
        try {
            ...
            ResourceConfig rc = new ResourceConfig().packages("edu.uci.ics.gamendo1.service.idm.resources");
